...
const Button = forwardRef(({ 
  ...
  const variants = {
    ...
    secondary: "bg-white text-primary-700 border-2 border-primary-200 hover:border-primary-300 hover:bg-primary-50 focus:ring-primary-500 shadow-sm hover:shadow-md",
